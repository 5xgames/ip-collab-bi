...
const products = [
  ["bleach-rebirth-of-souls", { default: "HP0700-PPSA02167_00-BLEACHROFS000000", SEA: "JP0700-PPSA02166_00-BLEACHROFS000000" }],
  ["captain-tsubasa-2-world-fighters", { default: "JP0700-PPSA22728_00-MAINGAME00000000" }],
  ["demon-slayer-hinokami-chronicles", { default: "HP0177-PPSA03170_00-HINOKAMI00000000", KR: "HP0177-PPSA03457_00-HINOKAMI00000000" }],
  ["demon-slayer-hinokami-chronicles-2", { default: "HP0177-PPSA25427_00-HINOKAMI20000000", KR: "HP0177-PPSA25428_00-HINOKAMI20000000" }],
  ["dragon-ball-sparking-zero", { default: "HP0700-PPSA15208_00-DRAGONBALLSPARK0", SEA: "JP0700-PPSA15207_00-DRAGONBALLSPARK0" }],
  ["echoes-of-aincrad", { default: "JP0700-PPSA22969_00-SWORDARTONLINEV0" }],
  ["fairy-tail-2", { default: "EP4108-PPSA24062_00-FAIRYTAIL2DDXSP0", KR: "HP0106-PPSA24061_00-APPFT20000000000" }],
  ["hunter-x-hunter-nen-impact", { default: "JP0036-PPSA24274_00-0000000000000000" }],
  ["jojo-all-star-battle-r", { default: "HP0700-PPSA02258_00-JASBRMAINGAME000", SEA: "JP0700-PPSA01745_00-JASBRMAINGAME000" }],
  ["jujutsu-kaisen-cursed-clash", { default: "HP0700-PPSA09534_00-JJKCVSX400000000", SEA: "JP0700-PPSA09533_00-JJKCVSX400000000" }],
  ["my-hero-ones-justice", { default: "HP0700-CUSA12082_00-ASIAPLACEHOLDER0", SEA: "EP0700-CUSA12399_00-ASIAPLACEHOLDER0" }],
  ["my-hero-academia-alls-justice", { default: "HP0700-PPSA26173_00-MAINGAME00000000", SEA: "JP0700-PPSA26172_00-MAINGAME00000000" }],
  ["naruto-storm-connections", { default: "HP0700-PPSA06979_00-NARUTOUNSA000000", SEA: "JP0700-PPSA06978_00-NARUTOUNSA000000" }],
  ["one-piece-world-seeker", { default: "HP0700-CUSA14016_00-ASIAFULLGAME0000", SEA: "EP0700-CUSA14054_00-ASIAFULLGAME0000" }],
  ["sand-land", { default: "HP0700-PPSA08573_00-SANDLMAINGAME000", SEA: "JP0700-CUSA34695_00-SANDLMAINGAME000" }],
];
...
function parseDisplayedDate(html) {
  ...
  let month;
  let day;
  if (numbers[0] > 1900) [year, month, day] = numbers;
...
async function auditProduct(projectId, storeId, region, definition) {
  ...
  try {
    ...
    const isProductPage = response.ok
      && html.includes('data-qa="mfe-game-title#name"')
    ...
    const actualLaunchDate = parseDisplayedDate(html) || "已上线（当地首发日期待核验）";
...
async function main() {
  ...
  data.meta.schemaVersion = "1.6";
  data.meta.phase = 11;
  data.meta.generatedAt = "2026-09-09T10:30:00+09:00";
